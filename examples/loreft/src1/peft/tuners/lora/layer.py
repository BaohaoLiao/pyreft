...
class LoraLayer(BaseTunerLayer):
    ...
    def update_layer(
        ...
        self.lora_A[adapter_name] = nn.Linear(self.out_features, 1, bias=False)
        self.lora_B[adapter_name] = nn.Linear(self.out_features, 1, bias=False)
    ...
    def _apply_rosa(self, x, lora_A, lora_B):
        lora_A_cos = lora_A.weight.squeeze().cos()
        lora_A_sin = lora_A.weight.squeeze().sin()
        lora_B_repeat = lora_B.weight.squeeze()
